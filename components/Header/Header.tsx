      ...
      <div className="container-fluid px-5 py-4 d-none d-lg-block">
        <div className="row gx-0 align-items-center text-center">
          ...
          <div className="col-md-4 col-lg-6 text-center">
            <div className="ps-4">
              <form onSubmit={handleSearch} className="d-flex align-items-center border rounded-pill search-header-form">
                <input
                  className="form-control border-0 rounded-pill w-100 py-3 search-header-input"
                  type="text"
                ...
                />
                <select
                  className="form-select text-dark border-0 border-start rounded-0 p-3 search-header-category"
                ...
                <button
                  type="submit"
                  className="btn btn-primary rounded-pill search-header-button"
                  aria-label="Search"
                >
